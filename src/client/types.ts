 ...
 */
export type ClientRunner<TReq = unknown, TRes = unknown> = (
 ...
 * ```
 */
export type ClientMiddleware<TReq = unknown, TRes = unknown> = (
 ...
 * ```
 */
export type TypedClientMiddleware<
  TProvides = {},
  TRequires = {},
  TReq = unknown,
  TRes = unknown,
 ...
 */
export type MiddlewareProvides<T> = T extends TypedClientMiddleware<infer P, any, any, any>
  ? P
  : {};
 ...
 */
export type MiddlewareRequires<T> = T extends TypedClientMiddleware<any, infer R, any, any>
  ? R
  : {};
...
export type ValidateMiddleware<
  TMiddleware extends TypedClientMiddleware<any, any, any, any>,
  TAccumulatedContext,
> = MiddlewareRequires<TMiddleware> extends TAccumulatedContext
  ? TMiddleware
  : never;
...
export type AccumulateContext<
  TMiddleware extends TypedClientMiddleware<any, any, any, any>,
  TAccumulatedContext,
> = TAccumulatedContext & MiddlewareProvides<TMiddleware>;
...
export class ClientError extends Error {
  constructor(
    public readonly status: Extract<Status, { type: "error" }>,
