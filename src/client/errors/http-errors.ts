 ...
 */
const HTTP_STATUS_ERROR_MAP: ReadonlyArray<readonly [HTTPStatus, ErrorCode]> = [
  // 4xx Client Errors
 ...
 */
export const HTTP_ERROR_REGISTRY: Record<string, ErrorMetadata> = {
  //
  ...
  [ErrorCode.HTTP_ERROR]: defineHTTPError(ErrorCode.HTTP_ERROR, 0 as HTTPStatus, {
    summary: "HTTP error",
  ...
  [ErrorCode.INVALID_URL]: defineHTTPError(ErrorCode.INVALID_URL, 0 as HTTPStatus, {
    summary: "Invalid URL",
  ...
  [ErrorCode.INVALID_METHOD]: defineHTTPError(ErrorCode.INVALID_METHOD, 0 as HTTPStatus, {
