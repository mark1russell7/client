 ...
 */
export const HTTPStatusToCode: Record<HTTPStatus, string> = {
 ...
 */
export const CodeToHTTPStatus: Record<string, HTTPStatus> = Object.fromEntries(
  Object.entries(HTTPStatusToCode).map(([status, code]) => [code, Number(status) as HTTPStatus])
) as Record<string, HTTPStatus>;
 ...
 */
export function isInformationalStatus(status: HTTPStatus): boolean {
 ...
 */
export function isRedirectStatus(status: HTTPStatus): boolean {
 ...
 */
export function isErrorStatus(status: HTTPStatus): boolean {
 ...
 */
export function isRetryableStatus(status: HTTPStatus): boolean {
 ...
 * ```
 */
export function getStatusCode(status: HTTPStatus): string {
 ...
 * ```
 */
export function getStatusFromCode(code: string): HTTPStatus {
 ...
 * ```
 */
export function formatHTTPError(status: HTTPStatus): string {
  return `${HTTP} ${status}`;
}
