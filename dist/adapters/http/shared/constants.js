 ...
 * HTTP Status Codes
 *
 * Comprehensive enum of all standard HTTP status codes.
 */
export var HTTPStatus;
(function (HTTPStatus) {
    // Unknown
    HTTPStatus[HTTPStatus["UNKNOWN"] = 0] = "UNKNOWN";
    // 1xx Informational
    HTTPStatus[HTTPStatus["CONTINUE"] = 100] = "CONTINUE";
    HTTPStatus[HTTPStatus["SWITCHING_PROTOCOLS"] = 101] = "SWITCHING_PROTOCOLS";
    HTTPStatus[HTTPStatus["PROCESSING"] = 102] = "PROCESSING";
    HTTPStatus[HTTPStatus["EARLY_HINTS"] = 103] = "EARLY_HINTS";
    HTTPStatus[HTTPStatus["RESPONSE_IS_TOO_LARGE"] = 104] = "RESPONSE_IS_TOO_LARGE";
    // 2xx Success
    ...
    HTTPStatus[HTTPStatus["HTTP_NETWORK_CONNECT_TIMEOUT_ERROR"] = 599] = "HTTP_NETWORK_CONNECT_TIMEOUT_ERROR";
})(HTTPStatus || (HTTPStatus = {}));
/**
 * HTTP Transport Protocol Name
 */
